...
def gp(update, context):
        zipk = context.args[0]
        open('1.txt','w').write(zipk)
        update.message.reply_text(f"ʙʏᴘᴀssɪɴɢ ʏᴏᴜʀ ɢᴘʟɪɴᴋs")
...
def droplink(update, context):
        zipk = context.args[0]
        open('1.txt','w').write(zipk)
        update.message.reply_text(f"ʙʏᴘᴀssɪɴɢ ʏᴏᴜʀ ᴅʀᴏᴘʟɪɴᴋs")
...
def gdtot(update, context):
        zipk = context.args[0]
        open('1.txt','w').write(zipk)
        update.message.reply_text(f"ʙʏᴘᴀssɪɴɢ ʏᴏᴜʀ ɢᴅᴛᴏᴛ ʟɪɴᴋs")
...
def hubdrive(update, context):
        zipk = context.args[0]
        open('1.txt','w').write(zipk)
        update.message.reply_text(f"ʙʏᴘᴀssɪɴɢ ʏᴏᴜʀ ʜᴜʙᴅʀɪᴠᴇ ʟɪɴᴋs")
...
def magic(update, context):
        zipk = context.args[0]
        open('1.txt','w').write(zipk)
        update.message.reply_text(f"ʙʏᴘᴀssɪɴɢ ʏᴏᴜʀ ᴜɴɪғɪᴇᴅ ʟɪɴᴋs")
...
def rocklinks(update, context):
        zipk = context.args[0]
        open('1.txt','w').write(zipk)
        update.message.reply_text(f"ʙʏᴘᴀssɪɴɢ ʏᴏᴜʀ ʀᴏᴄᴋʟɪɴᴋs")
